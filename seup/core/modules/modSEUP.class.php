...
class modSEUP extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 21351; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module
		...
		$this->description = "SEUPDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "SEUPDescription";

		// Author
		$this->editor_name = 'Informatička Udruga 8Core';
		...
		*/
		...
		/* BEGIN MODULEBUILDER LEFTMENU Otvoreni Predmeti */

		// Dodavanje stavke u bočni izbornik

		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
			'type' => 'left',  // Stavka u bočnom izborniku
			'titre' => 'Plan Klasifikacijskih Oznaka',  // Tekst koji će biti prikazan u bočnom izborniku
			'mainmenu' => 'seup',  // Kod menija (naš modul)
			'leftmenu' => 'Plan Klasifikacijskih Oznaka',  // Unikatni ID za stavku bočnog izbornika
			'url' => './seup/pages/plan_klasifikacijskih_oznaka.php',  // Putanja do stranice koja se otvara kad se klikne na link
			'langs' => 'seup@seup',  // Jezična datoteka
			'position' => 1000,  // Pozicija u izborniku
			'enabled' => '1',  // Provjera je li modul aktiviran
			'perms' => '1',  // Provjera prava pristupa
			'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
			'user' => 2,  // Stavka je dostupna svim korisnicima
			'object' => '',
		);
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
			'type' => 'left',  // Stavka u bočnom izborniku
			'titre' => 'Novi Predmet',  // Tekst koji će biti prikazan u bočnom izborniku
			'mainmenu' => 'seup',  // Kod menija (naš modul)
			'leftmenu' => 'Novi Predmet',  // Unikatni ID za stavku bočnog izbornika
			'url' => './seup/pages/novi_predmet.php',  // Putanja do stranice koja se otvara kad se klikne na link
			'langs' => 'seup@seup',  // Jezična datoteka
			'position' => 1002,  // Pozicija u izborniku
			'enabled' => '1',  // Provjera je li modul aktiviran
			'perms' => '1',  // Provjera prava pristupa
			'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
			'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
			'type' => 'left',  // Stavka u bočnom izborniku
			'titre' => 'Predmeti',  // Tekst koji će biti prikazan u bočnom izborniku
			'mainmenu' => 'seup',  // Kod menija (naš modul)
			'leftmenu' => 'Predmeti',  // Unikatni ID za stavku bočnog izbornika
			'url' => './seup/pages/predmeti.php',  // Putanja do stranice koja se otvara kad se klikne na link
			'langs' => 'seup@seup',  // Jezična datoteka
			'position' => 1003,  // Pozicija u izborniku
			'enabled' => '1',  // Provjera je li modul aktiviran
			'perms' => '1',  // Provjera prava pristupa
			'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
			'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		// 	'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
		// 	'type' => 'left',  // Stavka u bočnom izborniku
		// 	'titre' => 'Novi Akt',  // Tekst koji će biti prikazan u bočnom izborniku
		// 	'mainmenu' => 'seup',  // Kod menija (naš modul)
		// 	'leftmenu' => 'Novi Akt',  // Unikatni ID za stavku bočnog izbornika
		// 	'url' => './seup/pages/akt.php',  // Putanja do stranice koja se otvara kad se klikne na link
		// 	'langs' => 'seup@seup',  // Jezična datoteka
		// 	'position' => 1004,  // Pozicija u izborniku
		// 	'enabled' => '1',  // Provjera je li modul aktiviran
		// 	'perms' => '1',  // Provjera prava pristupa
		// 	'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
		// 	'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		// 	'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
		// 	'type' => 'left',  // Stavka u bočnom izborniku
		// 	'titre' => 'Otvoreni Predmeti',  // Tekst koji će biti prikazan u bočnom izborniku
		// 	'mainmenu' => 'seup',  // Kod menija (naš modul)
		// 	'leftmenu' => 'Otvoreni Predmeti',  // Unikatni ID za stavku bočnog izbornika
		// 	'url' => './seup/pages/otvoreni_predmeti.php',  // Putanja do stranice koja se otvara kad se klikne na link
		// 	'langs' => 'seup@seup',  // Jezična datoteka
		// 	'position' => 1005,  // Pozicija u izborniku
		// 	'enabled' => '1',  // Provjera je li modul aktiviran
		// 	'perms' => '1',  // Provjera prava pristupa
		// 	'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
		// 	'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
			'type' => 'left',  // Stavka u bočnom izborniku
			'titre' => 'Arhiva',  // Tekst koji će biti prikazan u bočnom izborniku
			'mainmenu' => 'seup',  // Kod menija (naš modul)
			'leftmenu' => 'Arhiva',  // Unikatni ID za stavku bočnog izbornika
			'url' => './seup/pages/arhiva.php',  // Putanja do stranice koja se otvara kad se klikne na link
			'langs' => 'seup@seup',  // Jezična datoteka
			'position' => 1006,  // Pozicija u izborniku
			'enabled' => '1',  // Provjera je li modul aktiviran
			'perms' => '1',  // Provjera prava pristupa
			'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
			'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
			'type' => 'left',  // Stavka u bočnom izborniku
			'titre' => 'Postavke',  // Tekst koji će biti prikazan u bočnom izborniku
			'mainmenu' => 'seup',  // Kod menija (naš modul)
			'leftmenu' => 'Postavke',  // Unikatni ID za stavku bočnog izbornika
			'url' => './seup/pages/postavke.php',  // Putanja do stranice koja se otvara kad se klikne na link
			'langs' => 'seup@seup',  // Jezična datoteka
			'position' => 1007,  // Pozicija u izborniku
			'enabled' => '1',  // Provjera je li modul aktiviran
			'perms' => '1',  // Provjera prava pristupa
			'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
			'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
			'type' => 'left',  // Stavka u bočnom izborniku
			'titre' => 'Text Editor',  // Tekst koji će biti prikazan u bočnom izborniku
			'mainmenu' => 'seup',  // Kod menija (naš modul)
			'leftmenu' => 'Text Editor',  // Unikatni ID za stavku bočnog izbornika
			'url' => './seup/pages/text_editor.php',  // Putanja do stranice koja se otvara kad se klikne na link
			'langs' => 'seup@seup',  // Jezična datoteka
			'position' => 1008,  // Pozicija u izborniku
			'enabled' => '1',  // Provjera je li modul aktiviran
			'perms' => '1',  // Provjera prava pristupa
			'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
			'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		// 	'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
		// 	'type' => 'left',  // Stavka u bočnom izborniku
		// 	'titre' => 'Tester',  // Tekst koji će biti prikazan u bočnom izborniku
		// 	'mainmenu' => 'seup',  // Kod menija (naš modul)
		// 	'leftmenu' => 'Tester',  // Unikatni ID za stavku bočnog izbornika
		// 	'url' => './seup/pages/tester.php',  // Putanja do stranice koja se otvara kad se klikne na link
		// 	'langs' => 'seup@seup',  // Jezična datoteka
		// 	'position' => 1009,  // Pozicija u izborniku
		// 	'enabled' => '1',  // Provjera je li modul aktiviran
		// 	'perms' => '1',  // Provjera prava pristupa
		// 	'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
		// 	'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=seup',  // Povezivanje s glavnim izbornikom
			'type' => 'left',  // Stavka u bočnom izborniku
			'titre' => 'Tagovi',  // Tekst koji će biti prikazan u bočnom izborniku
			'mainmenu' => 'seup',  // Kod menija (naš modul)
			'leftmenu' => 'Tagovi',  // Unikatni ID za stavku bočnog izbornika
			'url' => './seup/pages/tagovi.php',  // Putanja do stranice koja se otvara kad se klikne na link
			'langs' => 'seup@seup',  // Jezična datoteka
			'position' => 1010,  // Pozicija u izborniku
			'enabled' => '1',  // Provjera je li modul aktiviran
			'perms' => '1',  // Provjera prava pristupa
			'target' => '',  // Ako želite da se otvori u novom prozoru, postavite '_blank'
			'user' => 2,  // Stavka je dostupna svim korisnicima
		...
		/*
		$this->menu[$r++]=array(
			'fk_menu' => 'fk_mainmenu=seup,fk_leftmenu=myobject',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type' => 'left',			                // This is a Left menu entry
			'titre' => 'New_MyObject',
			'mainmenu' => 'seup',
			'leftmenu' => 'seup_myobject_new',
			'url' => '/seup/myobject_card.php?action=create',
			'langs' => 'seup@seup',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position' => 1000 + $r,
			'enabled' => 'isModEnabled("seup")', // Define condition to show or hide menu entry. Use 'isModEnabled("seup")' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms' => '$user->hasRight("seup", "myobject", "write")'
			'target' => '',
			'user' => 2,				                // 0=Menu for internal users, 1=external users, 2=both
			'object' => 'MyObject'
		);
		$this->menu[$r++]=array(
			...
			'titre' => 'List_MyObject',
			'mainmenu' => 'seup',
			'leftmenu' => 'seup_myobject_list',
			'url' => '/seup/myobject_list.php',
			'langs' => 'seup@seup',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position' => 1000 + $r,
			'enabled' => 'isModEnabled("seup")', // Define condition to show or hide menu entry. Use 'isModEnabled("seup")' if entry must be visible if module is enabled.
			'perms' => '$user->hasRight("seup", "myobject", "read")'
			'target' => '',
			'user' => 2,				                // 0=Menu for internal users, 1=external users, 2=both
			'object' => 'MyObject'
		);
